...
CFLAGS = -O2 -DTARGET_RS97 -DTARGET=$(TARGET) -D__BUILDTIME__="$(BUILDTIME)" -DLOG_LEVEL=0 $(SDL_CFLAGS) -I$(CHAINPREFIX)/usr/include/ -I$(SYSROOT)/usr/include/  -I$(SYSROOT)/usr/include/SDL/
CFLAGS += -std=gnu++11 -fdata-sections -ffunction-sections -fno-exceptions -fno-math-errno -fno-threadsafe-statics

CXXFLAGS = $(CFLAGS)
LDFLAGS = $(SDL_LIBS) -lSDL -lSDL_image -lSDL_ttf -lfreetype -lpng -ljpeg -lz -lpthread
